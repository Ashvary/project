...
import codingblocks.com.billsplit.TourFragment.OnListFragmentInteractionListener;
...
public class TourRecyclerViewAdapter extends RecyclerView.Adapter<TourRecyclerViewAdapter.ViewHolder> {
    ...
    public TourRecyclerViewAdapter(List<Tour> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
